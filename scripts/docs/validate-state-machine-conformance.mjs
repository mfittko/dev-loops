...
const PUBLIC_DEV_LOOP_GATE_TO_FIXTURE = new Map([
  ...
  [DEV_LOOP_GATE.REVIEW, () => evaluatePublicDevLoopRouting({ intent: DEV_LOOP_PUBLIC_INTENT.REVIEW_PR, target: { kind: DEV_LOOP_TARGET_KIND.PR, pr: 88 }, currentState: publicDevLoopPrState({}), targetPreference: PUBLIC_DEV_LOOP_GITHUB_FIRST })],
