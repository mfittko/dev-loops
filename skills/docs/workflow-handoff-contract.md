...
|---|---|---|---|---|---|
| `copilot_verification` | `draft` | AC check, scope, coverage, DoD alignment | commands-run, validation-output, review-findings | 4 | 300000 |
| `copilot_verification` | `watch` | Copilot activity detection, no stuck watch | commands-run | 2 | 1800000 |
| `copilot_verification` | `pre-approval` | Full pre-approval gate chain, clean verdict, unresolved threads, CI green | commands-run, validation-output, review-findings, residual-risks | 6 | 300000 |
...
|---|---|
| `copilot_verification` | `["draft-pr", "merge"]` |
| `issue_intake` | `["merge"]` |
