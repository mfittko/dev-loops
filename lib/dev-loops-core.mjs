...
// default. Every lifecycle result carries an explicit `record`, so severity
// reads the machine-readable state/action/record triple only: a result without
// `record` is a thrown-error shape from the catch paths below and must fail.
