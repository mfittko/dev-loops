...
const ORPHAN_ALLOWLIST = new Map([
  ...
  ["scripts/github/emit-coordinator-phase-blocked.mjs", "standalone — coordinator_phase role-budget-bound escape hatch (issue 2157 slice a of the 2153 epic), agent-invoked; wiring into a coordinator prompt is a later slice"],
