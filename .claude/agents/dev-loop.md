...
1. Run the deterministic startup resolver to produce the authoritative state bundle: `npx dev-loops@1.0.3 loop startup --issue <n>` for issues, or `npx dev-loops@1.0.3 loop startup --pr <n>` for PRs.
