...
11. **`git stash` in this repo's shared-`.git` worktree layout**: See `WORKTREE-NO-STASH` in [Worktree usage guidance](../../docs/worktree-guidance.md#never-git-stash-in-a-shared-git-layout).
