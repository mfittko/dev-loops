...
6. **Main-checkout mutation**: See `WORKTREE-DEFAULT-USE` in [Worktree usage guidance](./worktree-guidance.md#default-rule-use-a-worktree-for-mutating-local-work).
