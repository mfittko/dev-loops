...
const DEFAULT_SOURCE_EXCLUDES = Object.freeze([
  ...
  ".claude/skills",
  // Third-party vendored deps bundled verbatim into the Claude plugin tree (issue #2123's
  // scripts-root bundle — `yaml`, `zod`). Their own README/CHANGELOG markdown links are relative
  // to THEIR OWN upstream repo, not this one, so they are broken by design once vendored here.
  ".claude/node_modules",
]);
