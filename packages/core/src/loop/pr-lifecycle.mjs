...
export const PR_LIFECYCLE_TRANSITIONS = Object.freeze([
  ...
  Object.freeze(['ready_state_needs_copilot_request', 'waiting_for_external_review']),
  Object.freeze(['ready_state_needs_copilot_request', 'stopped_needs_user_decision']),
  Object.freeze(['waiting_for_external_review', 'copilot_feedback_remediation']),
  ...
  Object.freeze(['waiting_for_external_review', 'merge_conflict_resolution']),
  Object.freeze(['merge_conflict_resolution', 'waiting_for_external_review']),
  Object.freeze(['waiting_for_external_review', 'final_local_preapproval_gate']),
