...
test("packages/core exports the sanctioned runtime boundary and de-exports unused weak-runtime surfaces", async () => {
  ...
  assert.equal(packageJson.exports["./loop/finding-cluster"], "./src/loop/finding-cluster.mjs");
  ...
  assert.equal(packageJson.exports["./loop/watcher-exclusivity"], "./src/loop/watcher-exclusivity.mjs");
